        ...
        <main className="max-w-[1920px] mx-auto px-6 py-6 font-sans">
            ...
            <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
                <div className="p-4 bg-emerald-100 dark:bg-emerald-900/30 rounded-full mb-6">
                    <Key size={48} className="text-emerald-600 dark:text-emerald-400" />
                </div>
                <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-3">
                    {t('tools.masterKeyGenerator.name')}
                </h1>
                <p className="text-xl text-gray-600 dark:text-gray-400 max-w-lg mb-8">
                    {t('tools.masterKeyGenerator.desc')}
                </p>
                <div className="px-4 py-2 bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 rounded-lg font-medium">
                    {t('home.comingSoon')}
                </div>
            </div>
        </main>
